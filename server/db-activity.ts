...
export type ActivityAction =
  ...
  | "cloud.folderRename"
  | "cloud.folderRestore"
  | "cloud.folderPermanentDelete"
  | "cloud.fileUpload"
  | "cloud.fileDelete"
  | "cloud.fileRename"
  | "cloud.fileMove"
  | "cloud.folderMove"
  | "cloud.fileNewVersion"
  | "cloud.fileRestoreVersion"
  | "cloud.fileDownload"
  | "cloud.fileRestore"
  ...
  | "warehouse.purchaseRequestCreate"
  | "warehouse.purchaseRequestUpdate"
  | "warehouse.migration";
