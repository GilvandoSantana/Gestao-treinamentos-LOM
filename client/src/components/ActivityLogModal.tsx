...
const ACTION_INFO: Record<string, { label: string; className: string }> = {
  ...
  'certificate.download': { label: 'Baixou certificado', className: 'bg-navy/10 text-navy' },
  'fds.download': { label: 'Baixou FDS', className: 'bg-navy/10 text-navy' },
  'contract.downloadPgr': { label: 'Baixou PGR', className: 'bg-navy/10 text-navy' },
  ...
  'whatsapp.test': { label: 'Testou envio de WhatsApp', className: 'bg-muted text-muted-foreground' },
};
